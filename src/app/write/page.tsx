    ...
    <div className="max-w-4xl mx-auto">
      ...
      {!showPrompt && (
        <button
          ...
          className="mb-6 text-sm text-purple-600 hover:text-purple-700 flex items-center gap-1"
        >
          <Sparkles size={16} />
          Show today&apos;s prompt
        </button>
      ...
      <div className="mt-6 p-4 bg-blue-50 rounded-lg border border-blue-100">
        <p className="text-sm text-blue-900">
          <strong>Tip:</strong> Your entry is automatically saved as you write. Feel free to
          close this page and come back later!
        </p>
      </div>
    </div>
  )
